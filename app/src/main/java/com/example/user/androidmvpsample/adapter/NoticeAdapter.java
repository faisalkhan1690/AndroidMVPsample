package com.example.user.androidmvpsample.adapter;
...
import com.example.user.androidmvpsample.R;
import com.example.user.androidmvpsample.main_activity.RecyclerItemClickListener;
